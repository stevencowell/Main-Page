...
const card = b => `<article class="book-card" id="${e(b.id)}" data-subject="${e(b.subject)}" data-search="${e([b.title,b.subject,b.stage,b.type,b.description,b.includes].join(' ').toLocaleLowerCase('en-AU'))}" aria-labelledby="${e(b.id)}-title">
  <div class="cover-panel">
    <a class="cover-link" href="${e(b.pdf)}" target="_blank" rel="noopener" aria-label="Open ${e(b.title)} student workbook PDF (opens in a new tab)"><img src="${e(b.cover)}" width="701" height="991" alt="${e(b.title)} workbook cover" loading="lazy"></a>
    <a class="preview-link" href="${e(b.preview)}" data-preview data-title="${e(b.title)}" data-pdf="${e(b.pdf)}">Look inside <span aria-hidden="true">↗</span></a>
  </div>
  <div class="book-copy">
    <p class="book-meta">${e(b.stage)} · ${e(b.subject)} · ${e(b.type)}</p>
    <h3 id="${e(b.id)}-title"><a href="${e(b.pdf)}" target="_blank" rel="noopener">${e(b.title)}${newTab}</a></h3>
    ...
    <div class="book-actions"><a class="button primary" href="${e(b.pdf)}" target="_blank" rel="noopener">Open workbook (PDF) <span aria-hidden="true">↗</span>${newTab}</a><a class="button" href="${e(b.pdf)}" download="${e(b.id)}-student-workbook.pdf">Download PDF <span aria-hidden="true">↓</span></a></div>
