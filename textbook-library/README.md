...
This is the central catalogue of completed TAS textbooks and workbooks. It starts with the approved Desk Tidy Editorial Edition 2.0. Existing course sites remain the teaching hubs.
...
Do not silently replace an existing approved edition with an unfinished document. Source documents and production checks for Desk Tidy are retained in the creating task; only final public artifacts are included here.
